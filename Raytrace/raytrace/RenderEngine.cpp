...
void RenderEngine::load_files(int argc, char** argv)
{
  ...
  else
  {
    ...
    scene.add_plane(make_float3(0.0f, 0.0f, 0.0f), normalize(make_float3(0.0f, 1.0f, 0.0f)), "../models/default_scene.mtl", 1, 0.10f);
    ...
    scene.add_triangle(make_float3(-1.2f, 0.1f, -0.9f), make_float3(0.2f, 0.1f, -0.9f), make_float3(-1.2f, 0.1f, -2.1f), "../models/default_scene.mtl", 3);
	...
	//cam.set(make_float3(2.0f, 0.5f, 2.0f), make_float3(0.0f, 0.5, 0.0f), make_float3(0.0f, 1.0f, 0.0f), 1.0f);
	}
}
